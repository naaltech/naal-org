        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="text-sm text-muted-foreground space-y-3 leading-relaxed">
              <p>
              Form üzerinden iletilen veriler, <a href="https://eytrix.com" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors"><strong>Eytrix Inc.</strong></a> tarafından geliştirilen Llama 3.2 tabanlı başvuru işleme modülü tarafından işlenmektedir. Doğrulanan başvurular için, <a href="https://developers.google.com/workspace/admin/directory/v1/guides?hl=tr" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors"><strong>Google Workspace Directory API</strong></a> kullanılarak öğrenci e-posta hesapları otomatik olarak oluşturulur. Öğrencilerin hesap bilgileri ve başvuru durumu, sistem tarafından yapay zekâ tarafından oluşturulmuş sonuç yazısı ile <a href="mailto:mail@naal.org.tr" className="hover:text-foreground transition-colors"><strong>mail@naal.org.tr</strong></a> e-posta adresi üzerinden öğrencinin belirttiği e-posta adresine bildirilir.
              </p>
